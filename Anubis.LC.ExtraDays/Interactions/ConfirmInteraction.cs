...
namespace Anubis.LC.ExtraDays.Interactions
{
    /// <summary>
    ...
    public class ConfirmInteraction : ITerminalInteraction
    {
        ...
        public object HandleTerminalResponse(ArgumentStream arguments)
        {
            ...
            else if (response.Trim().Equals("deny", StringComparison.InvariantCultureIgnoreCase))
            {
                return Deny(arguments);
            }
        ...
        private object Deny(ArgumentStream arguments)
        {
            ...
            ExtraDaysToDeadlinePlugin.LogSource.LogInfo(DenyHandler.ToString());
            ExtraDaysToDeadlinePlugin.LogSource.LogInfo(DenyHandler.Target.ToString());
            ExtraDaysToDeadlinePlugin.LogSource.LogInfo(DenyHandler.GetMethodInfo());
